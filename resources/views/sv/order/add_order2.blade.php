<x-sales>
    <style>
        ...
        td del {
            ...
            color: red;
            /* Optional: Set a color for the strikethrough */
        }
    </style>
    <header>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <button class="btn nav-btn" data-search-type="all">
                                <h3><i class="bi bi-asterisk"></i></h3>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="btn nav-btn" data-search-type="barcode">
                                <h3><i class="bi bi-upc-scan"></i></h3>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="btn nav-btn" data-search-type="sku">
                                <h3><i class="bi bi-hash"></i></h3>
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="btn nav-btn" data-search-type="name">
                                <h3><i class="bi bi-tag-fill"></i></h3>
                            </button>
                        </li>
                    </ul>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-search"></i></span>
                        <input type="text" id="search_by" class="form-control"
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 options">
                ...
                <div class="row text-center d-flex justify-content-between payment-options">
                    <div id="cash" class="col-md-6 btn border border-success p-3">
                        <p>Cash</p>
                    </div>
                    <div id="upi" class="col-md-6 btn border border-success p-3">
                        <p>UPI</p>
                    </div>
                </div>
                <div></div>
                <div class="cart-options-2">
                    <div class="row d-flex justify-content-between">
                        <x-cart-options shortcut="F1" id="discount" icon="bi bi-percent" name="Discount" />
                        <x-cart-options shortcut="F2" id="close2" id="close" icon="bi bi-chat-left-dots"
                            name="Comment" />
                    ...
                    <div class="row d-flex justify-content-between">
                        <x-cart-options shortcut="F1" id="discount" icon="bi bi-floppy" name="Something" />
                        <x-cart-options shortcut="F2" id="close6" icon="bi bi-eraser-fill" name="Comment" />
                        <x-cart-options class="bg-success" id="close7" shortcut="F3"
                            icon="bi bi-person-raised-hand" name="F10 Payment" />
                    </div>
                    <div class="row d-flex justify-content-between">
                        ...
                        <x-cart-options class="bg-danger" id="discardOrder" shortcut="F3"
                            icon="bi bi-person-raised-hand" name="Void Order" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="number" class="form-control" id="quantityModalInput"
                            placeholder="Enter quantity" min="1" required>
                    </div>
                    <div class="modal-footer">
                        <!-- Button to set quantity -->
                        <button type="button" id="quantityModalSubmitBtn" class="btn btn-primary">Set
                            Quantity</button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="number" class="form-control" id="serviceModalInput" placeholder="Enter Price"
                            min="1" required>
                    </div>
                    <div class="modal-footer">
                        <!-- Button to set quantity -->
        ...
        <div class="modal fade" id="discountModal" tabindex="-1" aria-labelledby="discountModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="discountModalLabel">Change discount</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!-- Display item name -->
                        <p>Item Name: <span id="discountitemName"></span></p>

                        <!-- Input for entering discount -->
                        <label for="modalInput" class="form-label">Enter discount:</label>
                        <input type="number" class="form-control" id="discountModalInput"
                            placeholder="Enter discount" min="1" required>
                    </div>
                    <div class="modal-footer">
                        <!-- Button to set discount -->
                        <button type="button" id="discountModalSubmitBtn" class="btn btn-primary">Set
                            discount</button>
                    </div>
                </div>
            </div>
