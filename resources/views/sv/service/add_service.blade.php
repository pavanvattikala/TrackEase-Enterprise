			...
			<form class="form-horizontal" method="POST" action="/service/insert_service" id="createOrderForm">
						...
						@for($x=1;$x<2;$x++)
							<tr id="row{{$x}}" class="{{$arrayNumber}}">			  				
								...
								<td style="padding-left:20px;">			  					
									<input type="text" name="rate[]" id="rate{{$x}}" onkeyup="subAmount()" autocomplete="off" class="form-control" />			  					
								</td>
								<td style="padding-left:20px;">
									<div class="form-group">
									<input type="number" name="quantity[]" id="quantity{{$x}}" onkeyup="subAmount()" autocomplete="off" class="form-control" min="1" value="1" />
									</div>
								</td>
								<td style="padding-left:20px;">			  					
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input type="text" class="form-control" id="discount" name="discount" onkeyup="subAmount()" autocomplete="off" value="0"/>
					  </div>
					</div> <!--/form-group-->	
					<div class="form-group">
